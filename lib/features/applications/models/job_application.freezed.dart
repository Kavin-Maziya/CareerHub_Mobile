...
mixin _$JobApplication {
 ...
 String get id; String get jobTitle; DateTime get submittedAt; ApplicationStatus get status;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is JobApplication&&(identical(other.id, id) || other.id == id)&&(identical(other.jobTitle, jobTitle) || other.jobTitle == jobTitle)&&(identical(other.submittedAt, submittedAt) || other.submittedAt == submittedAt)&&(identical(other.status, status) || other.status == status));
}


@override
int get hashCode => Object.hash(runtimeType,id,jobTitle,submittedAt,status);

@override
String toString() {
  return 'JobApplication(id: $id, jobTitle: $jobTitle, submittedAt: $submittedAt, status: $status)';
}
...
@useResult
$Res call({
 String id, String jobTitle, DateTime submittedAt, ApplicationStatus status
});
...
/// Create a copy of JobApplication
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? jobTitle = null,Object? submittedAt = null,Object? status = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String jobTitle,  DateTime submittedAt,  ApplicationStatus status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _JobApplication() when $default != null:
return $default(_that.id,_that.jobTitle,_that.submittedAt,_that.status);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String jobTitle,  DateTime submittedAt,  ApplicationStatus status)  $default,) {final _that = this;
switch (_that) {
case _JobApplication():
return $default(_that.id,_that.jobTitle,_that.submittedAt,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String jobTitle,  DateTime submittedAt,  ApplicationStatus status)?  $default,) {final _that = this;
switch (_that) {
case _JobApplication() when $default != null:
return $default(_that.id,_that.jobTitle,_that.submittedAt,_that.status);case _:
  return null;
...
class _JobApplication extends JobApplication {
  const _JobApplication({required this.id, required this.jobTitle, required this.submittedAt, required this.status}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _JobApplication&&(identical(other.id, id) || other.id == id)&&(identical(other.jobTitle, jobTitle) || other.jobTitle == jobTitle)&&(identical(other.submittedAt, submittedAt) || other.submittedAt == submittedAt)&&(identical(other.status, status) || other.status == status));
}
...
/// Create a copy of JobApplication
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? jobTitle = null,Object? submittedAt = null,Object? status = null,}) {
