...
const JobCacheSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'salaryDisplay': PropertySchema(
      id: 7,
      name: r'salaryDisplay',
      type: IsarType.string,
    ),
...
int _jobCacheEstimateSize(
  ...
  {
    final value = object.salaryDisplay;
    if (value != null) {
...
void _jobCacheSerialize(
  ...
  writer.writeString(offsets[7], object.salaryDisplay);
...
JobCache _jobCacheDeserialize(
  ...
  object.salaryDisplay = reader.readStringOrNull(offsets[7]);
...
extension JobCacheQueryFilter
  ...
  salaryDisplayIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNull(property: r'salaryDisplay'),
      );
    });
  }

  QueryBuilder<JobCache, JobCache, QAfterFilterCondition>
  salaryDisplayIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNotNull(property: r'salaryDisplay'),
      );
    });
  }

  QueryBuilder<JobCache, JobCache, QAfterFilterCondition> salaryDisplayEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<JobCache, JobCache, QAfterFilterCondition> salaryDisplayLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<JobCache, JobCache, QAfterFilterCondition> salaryDisplayBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<JobCache, JobCache, QAfterFilterCondition>
  salaryDisplayStartsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.startsWith(
          property: r'salaryDisplay',
  ...
  QueryBuilder<JobCache, JobCache, QAfterFilterCondition> salaryDisplayEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<JobCache, JobCache, QAfterFilterCondition> salaryDisplayContains(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<JobCache, JobCache, QAfterFilterCondition> salaryDisplayMatches(
    String pattern, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<JobCache, JobCache, QAfterFilterCondition>
  salaryDisplayIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'salaryDisplay', value: ''),
      );
    });
  }

  QueryBuilder<JobCache, JobCache, QAfterFilterCondition>
  salaryDisplayIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(property: r'salaryDisplay', value: ''),
      );
    });
  }
...
extension JobCacheQuerySortBy on QueryBuilder<JobCache, JobCache, QSortBy> {
  ...
  QueryBuilder<JobCache, JobCache, QAfterSortBy> sortBySalaryDisplay() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'salaryDisplay', Sort.asc);
    });
  }

  QueryBuilder<JobCache, JobCache, QAfterSortBy> sortBySalaryDisplayDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'salaryDisplay', Sort.desc);
    });
  }
...
extension JobCacheQuerySortThenBy
  ...
  QueryBuilder<JobCache, JobCache, QAfterSortBy> thenBySalaryDisplay() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'salaryDisplay', Sort.asc);
    });
  }

  QueryBuilder<JobCache, JobCache, QAfterSortBy> thenBySalaryDisplayDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'salaryDisplay', Sort.desc);
    });
  }
...
extension JobCacheQueryWhereDistinct
  ...
  QueryBuilder<JobCache, JobCache, QDistinct> distinctBySalaryDisplay({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(
...
extension JobCacheQueryProperty
  ...
  QueryBuilder<JobCache, String?, QQueryOperations> salaryDisplayProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'salaryDisplay');
    });
  }
